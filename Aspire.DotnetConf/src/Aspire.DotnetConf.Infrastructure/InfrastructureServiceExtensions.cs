using Aspire.DotnetConf.Core.Interfaces;
using Aspire.DotnetConf.Core.Services;
using Aspire.DotnetConf.Infrastructure.Data;
using Aspire.DotnetConf.Infrastructure.Data.Queries;
using Aspire.DotnetConf.UseCases.Contributors.List;

namespace Aspire.DotnetConf.Infrastructure;
