...
1. Set `Aspire.DotnetConf.AspireHost` as the startup project
...
```bash
dotnet ef migrations add MigrationName -c AppDbContext -p ../Aspire.DotnetConf.Infrastructure/Aspire.DotnetConf.Infrastructure.csproj -s Aspire.DotnetConf.Web.csproj -o Data/Migrations
```

To update the database:
```bash
dotnet ef database update -c AppDbContext -p ../Aspire.DotnetConf.Infrastructure/Aspire.DotnetConf.Infrastructure.csproj -s Aspire.DotnetConf.Web.csproj
```
