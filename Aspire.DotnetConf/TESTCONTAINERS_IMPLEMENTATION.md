...
**Updated `tests\Aspire.DotnetConf.FunctionalTests\Aspire.DotnetConf.FunctionalTests.csproj`:**
- Removed: `Microsoft.EntityFrameworkCore.InMemory`
- Added: `Testcontainers` and `Testcontainers.MsSql`

### 2. CustomWebApplicationFactory

**File:** `tests\Aspire.DotnetConf.FunctionalTests\CustomWebApplicationFactory.cs`
...
```bash
dotnet test tests\Aspire.DotnetConf.FunctionalTests\Aspire.DotnetConf.FunctionalTests.csproj
```
